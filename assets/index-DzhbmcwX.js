 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const et=globalThis,D=et.trustedTypes,at=D?D.createPolicy("lit-html",{createHTML:i=>i}):void 0,gt="$lit$",y=`lit$${Math.random().toFixed(9).slice(2)}$`,_t="?"+y,Tt=`<${_t}>`,w=document,U=()=>w.createComment(""),T=i=>i===null||typeof i!="object"&&typeof i!="function",st=Array.isArray,zt=i=>st(i)||typeof i?.[Symbol.iterator]=="function",Y=`[ 	
\f\r]`,R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ht=/-->/g,dt=/>/g,A=RegExp(`>|${Y}(?:([^\\s"'>=/]+)(${Y}*=${Y}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ut=/'/g,pt=/"/g,yt=/^(?:script|style|textarea|title)$/i,kt=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),v=kt(1),C=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),ft=new WeakMap,b=w.createTreeWalker(w,129);function At(i,t){if(!st(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return at!==void 0?at.createHTML(t):t}const Ht=(i,t)=>{const e=i.length-1,s=[];let r,o=t===2?"<svg>":t===3?"<math>":"",n=R;for(let h=0;h<e;h++){const l=i[h];let u,a,p=-1,c=0;for(;c<l.length&&(n.lastIndex=c,a=n.exec(l),a!==null);)c=n.lastIndex,n===R?a[1]==="!--"?n=ht:a[1]!==void 0?n=dt:a[2]!==void 0?(yt.test(a[2])&&(r=RegExp("</"+a[2],"g")),n=A):a[3]!==void 0&&(n=A):n===A?a[0]===">"?(n=r??R,p=-1):a[1]===void 0?p=-2:(p=n.lastIndex-a[2].length,u=a[1],n=a[3]===void 0?A:a[3]==='"'?pt:ut):n===pt||n===ut?n=A:n===ht||n===dt?n=R:(n=A,r=void 0);const d=n===A&&i[h+1].startsWith("/>")?" ":"";o+=n===R?l+Tt:p>=0?(s.push(u),l.slice(0,p)+gt+l.slice(p)+y+d):l+y+(p===-2?h:d)}return[At(i,o+(i[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]};class z{constructor({strings:t,_$litType$:e},s){let r;this.parts=[];let o=0,n=0;const h=t.length-1,l=this.parts,[u,a]=Ht(t,e);if(this.el=z.createElement(u,s),b.currentNode=this.el.content,e===2||e===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(r=b.nextNode())!==null&&l.length<h;){if(r.nodeType===1){if(r.hasAttributes())for(const p of r.getAttributeNames())if(p.endsWith(gt)){const c=a[n++],d=r.getAttribute(p).split(y),$=/([.?@])?(.*)/.exec(c);l.push({type:1,index:o,name:$[2],strings:d,ctor:$[1]==="."?Wt:$[1]==="?"?qt:$[1]==="@"?Dt:B}),r.removeAttribute(p)}else p.startsWith(y)&&(l.push({type:6,index:o}),r.removeAttribute(p));if(yt.test(r.tagName)){const p=r.textContent.split(y),c=p.length-1;if(c>0){r.textContent=D?D.emptyScript:"";for(let d=0;d<c;d++)r.append(p[d],U()),b.nextNode(),l.push({type:2,index:++o});r.append(p[c],U())}}}else if(r.nodeType===8)if(r.data===_t)l.push({type:2,index:o});else{let p=-1;for(;(p=r.data.indexOf(y,p+1))!==-1;)l.push({type:7,index:o}),p+=y.length-1}o++}}static createElement(t,e){const s=w.createElement("template");return s.innerHTML=t,s}}function x(i,t,e=i,s){if(t===C)return t;let r=s!==void 0?e._$Co?.[s]:e._$Cl;const o=T(t)?void 0:t._$litDirective$;return r?.constructor!==o&&(r?._$AO?.(!1),o===void 0?r=void 0:(r=new o(i),r._$AT(i,e,s)),s!==void 0?(e._$Co??=[])[s]=r:e._$Cl=r),r!==void 0&&(t=x(i,r._$AS(i,t.values),r,s)),t}class Lt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,r=(t?.creationScope??w).importNode(e,!0);b.currentNode=r;let o=b.nextNode(),n=0,h=0,l=s[0];for(;l!==void 0;){if(n===l.index){let u;l.type===2?u=new k(o,o.nextSibling,this,t):l.type===1?u=new l.ctor(o,l.name,l.strings,this,t):l.type===6&&(u=new Vt(o,this,t)),this._$AV.push(u),l=s[++h]}n!==l?.index&&(o=b.nextNode(),n++)}return b.currentNode=w,r}p(t){let e=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class k{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,r){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=x(this,t,e),T(t)?t===f||t==null||t===""?(this._$AH!==f&&this._$AR(),this._$AH=f):t!==this._$AH&&t!==C&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):zt(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==f&&T(this._$AH)?this._$AA.nextSibling.data=t:this.T(w.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:s}=t,r=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=z.createElement(At(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===r)this._$AH.p(e);else{const o=new Lt(r,this),n=o.u(this.options);o.p(e),this.T(n),this._$AH=o}}_$AC(t){let e=ft.get(t.strings);return e===void 0&&ft.set(t.strings,e=new z(t)),e}k(t){st(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,r=0;for(const o of t)r===e.length?e.push(s=new k(this.O(U()),this.O(U()),this,this.options)):s=e[r],s._$AI(o),r++;r<e.length&&(this._$AR(s&&s._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const s=t.nextSibling;t.remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class B{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,r,o){this.type=1,this._$AH=f,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=f}_$AI(t,e=this,s,r){const o=this.strings;let n=!1;if(o===void 0)t=x(this,t,e,0),n=!T(t)||t!==this._$AH&&t!==C,n&&(this._$AH=t);else{const h=t;let l,u;for(t=o[0],l=0;l<o.length-1;l++)u=x(this,h[s+l],e,l),u===C&&(u=this._$AH[l]),n||=!T(u)||u!==this._$AH[l],u===f?t=f:t!==f&&(t+=(u??"")+o[l+1]),this._$AH[l]=u}n&&!r&&this.j(t)}j(t){t===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Wt extends B{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===f?void 0:t}}class qt extends B{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==f)}}class Dt extends B{constructor(t,e,s,r,o){super(t,e,s,r,o),this.type=5}_$AI(t,e=this){if((t=x(this,t,e,0)??f)===C)return;const s=this._$AH,r=t===f&&s!==f||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==f&&(s===f||r);r&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class Vt{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){x(this,t)}}const It=et.litHtmlPolyfillSupport;It?.(z,k),(et.litHtmlVersions??=[]).push("3.3.1");const Bt=(i,t,e)=>{const s=e?.renderBefore??t;let r=s._$litPart$;if(r===void 0){const o=e?.renderBefore??null;s._$litPart$=r=new k(t.insertBefore(U(),o),o,void 0,e??{})}return r._$AI(i),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const J=()=>new se;class se{}const K=new WeakMap,Z=Kt(class extends ee{render(i){return f}update(i,[t]){const e=t!==this.G;return e&&this.G!==void 0&&this.rt(void 0),(e||this.lt!==this.ct)&&(this.G=t,this.ht=i.options?.host,this.rt(this.ct=i.element)),f}rt(i){if(this.isConnected||(i=void 0),typeof this.G=="function"){const t=this.ht??globalThis;let e=K.get(t);e===void 0&&(e=new WeakMap,K.set(t,e)),e.get(this.G)!==void 0&&this.G.call(this.ht,void 0),e.set(this.G,i),i!==void 0&&this.G.call(this.ht,i)}else this.G.value=i}get lt(){return typeof this.G=="function"?K.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});var ie=Object.defineProperty,E=(i,t,e,s)=>{for(var r=void 0,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=n(t,e,r)||r);return r&&ie(t,e,r),r};const rt=class rt extends M{constructor(){super(...arguments),this.itemRefs=[],this.overflowRef=J(),this.resizeObserver=null,this.measuredWidths=[],this.overflowWidth=0,this.measured=!1,this.visibleCount=0,this._cumulativeWidths=null,this.items=[],this.itemRenderer=null,this.overflowRenderer=null}async firstUpdated(){await this.updateComplete,this.resizeObserver||(this.resizeObserver=new ResizeObserver(()=>this.onContainerResize()),this.resizeObserver.observe(this.parentElement||this))}async updated(t){t.has("items")&&(this.measured=!1,this.itemRefs=[],await this.updateComplete,this.measureAllItems())}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver?.disconnect(),this.resizeObserver=null}measureAllItems(){this.items.forEach((t,e)=>{this.itemRefs[e]||(this.itemRefs[e]=J())}),this.updateComplete.then(()=>{const t=[];this.items.forEach((e,s)=>{const r=this.itemRefs[s]?.value||null;t[s]=r?r.getBoundingClientRect().width:0}),this.measureOverflowWidth(),this.measuredWidths=t,this.measured=!0,this.updateComplete.then(()=>{this.computeVisibleForCurrentWidth({force:!0})})})}measureOverflowWidth(){const t=this.overflowRef.value;this.overflowWidth=t?.getBoundingClientRect().width??0}onContainerResize(){this.computeVisibleForCurrentWidth()}async computeVisibleForCurrentWidth({force:t=!1}={}){const e=this.parentElement?.clientWidth??0,s=this.measuredWidths,r=this.items.length;if(r===0||e<=0){this.visibleCount!==0&&(this.visibleCount=0);return}if(t||!this._cumulativeWidths||this._cumulativeWidths.length!==s.length){const d=new Array(s.length);let $=0;for(let m=0;m<s.length;m++)$+=s[m]??0,d[m]=$;this._cumulativeWidths=d}const o=this._cumulativeWidths,n=this.overflowWidth||0;let h=0,l=s.length-1,u;for(;h<=l;)u=h+l>>1,o[u]<=e?h=u+1:l=u-1;let a=h;if(r-a>0&&n>0)for(;a>0&&o[a-1]+n>e;)a--;a!==this.visibleCount&&(this.visibleCount=a)}render(){const{items:t,visibleCount:e,itemRenderer:s,overflowRenderer:r,measured:o,itemRefs:n}=this;if(!s)return v`<div>No renderer provided</div>`;if(!o)return t.forEach((u,a)=>{n[a]||(n[a]=J())}),v`
  ...
  `;let g=rt;E([G()],g.prototype,"measuredWidths");E([G()],g.prototype,"overflowWidth");E([G()],g.prototype,"measured");E([G()],g.prototype,"visibleCount");E([j({type:Array})],g.prototype,"items");E([j({attribute:!1})],g.prototype,"itemRenderer");E([j({attribute:!1})],g.prototype,"overflowRenderer");customElements.define("overflow-wc",g);const $t=["red","magenta","purple","blue","cyan","teal","green","gray","cool-gray","warm-gray"],vt=["Alpha","Beta","Gamma","Delta","Orion","Zenith","Nova","Cosmos","Pixel","Quantum"];function re(i){return Array.from({length:i}).map((t,e)=>({id:`item-${e+1}`,label:vt[e%vt.length],type:$t[e%$t.length],onClick:()=>console.log(`Clicked item-${e+1}`)}))}let L="tag",W="operational-tag";function oe(i){switch(L){case"tag":return v`
      ...
      </cds-overflow-menu> `;default:return v``}}window.addEventListener("DOMContentLoaded",()=>{const i=document.querySelectorAll("overflow-wc"),t=document.querySelector("cds-number-input"),e=document.querySelectorAll("cds-popover"),s=document.querySelector('cds-select[label-text="Theme"]'),r=document.querySelector('cds-select[label-text="Item Renderer"]'),o=document.querySelector('cds-select[label-text="Overflow Renderer"]'),n=c=>c?c.value??c.getAttribute?.("value")??c.querySelector?.("cds-select-item[selected]")?.getAttribute("value")??null:null,h="overflow-wc-config",l=c=>{try{localStorage.setItem(h,JSON.stringify(c))}catch{}},u=()=>{try{const c=localStorage.getItem(h);return c?JSON.parse(c):null}catch{return null}},a=()=>{const c=t?.value??t?.getAttribute?.("value"),d=parseInt(c||"0",10)||0;i.forEach(m=>{m.items=re(d),m.itemRenderer=oe,m.overflowRenderer=ne});const $=u()||{};$.count=d,l($)},p=()=>{const c=u(),d=c?.itemVariant??n(r);if(d&&["tag","dismissable-tag","button","icon-button"].includes(d)){L=d;try{if(r){r.value=d,r.setAttribute?.("value",d);const _=r.querySelector?.(`cds-select-item[value="${d}"]`);_&&(r.querySelectorAll?.("cds-select-item[selected]")?.forEach(O=>O.removeAttribute("selected")),_.setAttribute("selected",""))}}catch{}}const $=c?.overflowVariant??n(o);if($){W=$;try{if(o){o.value=$,o.setAttribute?.("value",$);const _=o.querySelector?.(`cds-select-item[value="${$}"]`);_&&(o.querySelectorAll?.("cds-select-item[selected]")?.forEach(O=>O.removeAttribute("selected")),_.setAttribute("selected",""))}}catch{}}const m=c?.theme??n(s);if(m){document.body.className=`cds-theme-zone-${m}`;try{if(s){s.value=m,s.setAttribute?.("value",m);const _=s.querySelector?.(`cds-select-item[value="${m}"]`);_&&(s.querySelectorAll?.("cds-select-item[selected]")?.forEach(O=>O.removeAttribute("selected")),_.setAttribute("selected",""))}}catch{}}const F=c?.count;if(typeof F=="number")try{t&&(t.setAttribute?.("value",String(F)),t.value=String(F))}catch{}};t&&(t.addEventListener("cds-number-input",c=>{a();const d=c?.detail?.value??c?.detail?.valueAsNumber;if(typeof d<"u"){const $=u()||{};$.count=parseInt(String(d),10)||$.count||0,l($)}}),t.addEventListener("change",a),t.addEventListener("input",a)),r?.addEventListener("cds-select-selected",()=>{const c=n(r);if(c){L=c;const d=u()||{};d.itemVariant=L,l(d),a()}}),o?.addEventListener("cds-select-selected",()=>{const c=n(o);if(c){W=c;const d=u()||{};d.overflowVariant=W,l(d),a()}}),s?.addEventListener("cds-select-selected",()=>{const c=n(s);if(c){document.body.className=`cds-theme-zone-${c}`;const d=u()||{};d.theme=c,l(d)}}),e.forEach(c=>c.addEventListener("click",d=>d.stopPropagation())),p(),requestAnimationFrame(()=>{a()})});
